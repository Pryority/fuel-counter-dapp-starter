...
// command
import { FuelDappAbi__factory } from "./contracts";
...
const CONTRACT_ID =
  "0xef066899413ef8dc7c3073a50868bafb3d039d9bad8006c2635b7f0efa992553"; // REPLACE THIS WITH EACH DEPLOY / RE-DEPLOY
...
// wallet above.
const contract = FuelDappAbi__factory.connect(CONTRACT_ID, wallet);
